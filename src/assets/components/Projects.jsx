...
const Projects = () => {
    ...
    const projects = [
        ...
        {
            id: 3,
            title: "Transform Your School with Smart Technology",
            description: "we create a safe, supportive and inspiring learning environment where students discover abilities, build character and prepare for a meaningful future.",
